...
//see http://tech.dolhub.com/Code/MathEval
 ...
 *     '^'       80 / 81     NO_SIDE        Power
 *     '\uC2B1'       60 / 60     RIGHT_SIDE     Unary negation (internal, substituted for '-')
 *     '*'       40 / 40     NO_SIDE        Multiple (conventional computer notation)
 *     '\uC397'       40 / 40     NO_SIDE        Multiple (because it's a Unicode world out there)
 *     '\uC2B7'       40 / 40     NO_SIDE        Multiple (because it's a Unicode world out there)
 *     '('       40 / 40     NO_SIDE        Multiply (implicit due to brackets, e.g "(a)(b)")
 *     '/'       40 / 40     NO_SIDE        Divide (conventional computer notation)
 *     '\uC3B7'       40 / 40     NO_SIDE        Divide (because it's a Unicode world out there)
...
//              if(fncnam.equalsIgnoreCase("nextUp"        )) { return Math.nextUp     (fncargs.next());                } needs Java 6
        ...
        static private final Operator OPR_NEG = new Operator('\uC2B1', 60, 60, RIGHT_SIDE, true, DefaultImpl.INSTANCE); // unary negation
        static private final Operator OPR_MLT1 = new Operator('*', 40, DefaultImpl.INSTANCE); // multiply (classical)
        static private final Operator OPR_MLT2 = new Operator('\uC397', 40, DefaultImpl.INSTANCE); // multiply (because it's a Unicode world out there)
        static private final Operator OPR_MLT3 = new Operator('\uC2B7', 40, DefaultImpl.INSTANCE); // multiply (because it's a Unicode world out there)
        ...
        static private final Operator OPR_DIV2 = new Operator('\uC3B7', 40, DefaultImpl.INSTANCE); // divide (because it's a Unicode world out there)
